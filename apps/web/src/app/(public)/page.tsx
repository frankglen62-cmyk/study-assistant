              ...
              return (
                <motion.div key={feature.title} variants={staggerItem}>
                  <InteractiveCard className="rounded-2xl border border-white/[0.06] bg-white/[0.02] p-6">
                    <span className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-emerald-500/10 text-emerald-400 text-xs font-medium ring-1 ring-inset ring-emerald-500/20 mb-6">
                    <span className="relative flex h-2 w-2">
                      <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-emerald-400 opacity-75"></span>
                      <span className="relative inline-flex rounded-full h-2 w-2 bg-emerald-500"></span>
                    </span>
                    Extension v0.1.53 is live
                  </span>
