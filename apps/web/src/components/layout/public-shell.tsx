      ...
      <header className="sticky top-0 z-50 border-b border-white/[0.06] bg-[#0a0a0a]/80 backdrop-blur-xl">
        <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <Link
              href="/register"
              className="inline-flex items-center rounded-lg bg-white px-4 py-2 text-sm font-semibold text-black transition-all hover:bg-neutral-200"
            >
              Get Started
            </Link>
          </div>
      ...
      <footer className="border-t border-white/[0.06] bg-[#111111]">
        <div className="mx-auto max-w-7xl px-6 py-16">
          <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-5">
            ...
            <div className="lg:col-span-1">
              ...
              <div className="mt-6 flex gap-4">
                <a href="#" className="text-neutral-500 transition-colors hover:text-white" aria-label="Twitter / X">
                ...
                <a href="#" className="text-neutral-500 transition-colors hover:text-white" aria-label="Instagram">
          ...
          <div className="mt-12 flex flex-col items-center justify-between gap-4 border-t border-white/[0.06] pt-8 sm:flex-row">
            <p className="text-sm text-neutral-600">© {new Date().getFullYear()} Study Assistant. All Rights Reserved.</p>
          </div>
        </div>
      </footer>
    </div>
