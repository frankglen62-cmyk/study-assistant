...
import { PublicPricingPreview } from '@/features/public/public-pricing-preview';
...
interface HomePageClientProps {
  pricingPackages: PaymentPackageDisplay[];
}

export function HomePageClient({ pricingPackages }: HomePageClientProps) {
      ...
      <section className="py-24">
        <div className="mx-auto max-w-7xl px-6">
          ...
          <motion.div
            ...
            viewport={{ once: true, amount: 0.15 }}
          >
            <PublicPricingPreview packages={pricingPackages} />
          </motion.div>
        </div>
      </section>
