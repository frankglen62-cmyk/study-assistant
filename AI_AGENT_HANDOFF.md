...
> The user NO LONGER uses `localhost`. The application is deployed online via Railway (`study-assistantweb-production.up.railway.app`) connected to the GitHub repository (`https://github.com/frankglen62-cmyk/study-assistant.git`). 
