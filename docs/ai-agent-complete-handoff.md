...
4. If the issue is still visible:
...
## 20. Quick Resume Prompt for Another AI Agent

If another AI agent needs to continue, use this:

`Continue from docs/ai-agent-complete-handoff.md. Check current web runtime, extension version, subject sources, and rebuild/restart if any recent changes are not visible.`
